    ...
    return (
        <ProtectedRoute className='h-screen flex flex-col text-center justify-center items-center'>
            <WithHead
                ...
                description=""
            >
                <h1 className='font-bold text-xl mb-1'>Welcome to {APP_NAMES['en']} Dashboard</h1>
                <p className='font-light text-lg mb-3'>This is an authorized page (Dashboard)</p>
                <button type="button" onClick={auth.signOutApp} className='px-5 py-2 rounded border font-medium uppercase tracking-[0.075rem] bg-neutral-900 text-white lg:hover:bg-neutral-600'>
                    Logout
                </button>
            </WithHead>
        </ProtectedRoute>
